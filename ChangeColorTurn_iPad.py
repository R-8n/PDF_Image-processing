...
if check_password():
    ...
    # ★修正：文字が重ならないよう、マイナスの余白を緩和した「程よいコンパクト」CSS
    st.markdown("""
        <style>
        ...
        h3 { padding-bottom: 8px !important; font-size: 22px !important; }
        p { font-size: 16px !important; }
        
        /* 程よい行間圧縮（文字が重ならないように 0rem -> 0.5rem に緩和） */
        [data-testid="stVerticalBlock"] { gap: 0.5rem !important; }
        [data-testid="column"] { gap: 0.5rem !important; }
        
        /* スライダー特有の上下スペースを削減（マイナスすぎないように調整） */
        .stSlider { padding-top: 0px !important; padding-bottom: 0px !important; margin-top: -5px !important; margin-bottom: -5px !important; }
