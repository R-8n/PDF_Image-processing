...
if check_password():
    st.markdown("""
        ...
        .stButton > button { background-color: #444 !important; color: white !important; height: 100%; min-height: 40px; }
    ...
    if uploaded_file is not None:
        ...
        with col2:
            ...
            # ★ポイント：expand=False でキャンバスサイズを固定します！
        ...
        if st.button("【3】変更を適用して保存", type="primary"):
            with st.spinner("PDFを生成中..."):
                ...
                for i in range(total_pages):
                    ...
                    # ★ポイント：保存時も expand=False でキャンバスサイズを固定します！
                    if ang != 0.0:
